...
RTL8723DS_MP_DRIVER_SITE = https://github.com/Groguard/RTL8723DS
...
define RTL8723DS_MP_DRIVER_EXTRA_INSTALL
	...
	$(INSTALL) -D -m 0644 $(RTL8723DS_MP_DRIVER_PKGDIR)/rtl8723ds_mp.conf \
		$(TARGET_DIR)/etc/modprobe.d/rtl8723ds_mp.conf
	$(INSTALL) -m 0755 -D $(RTL8723DS_MP_DRIVER_PKGDIR)/S20_rtl8723ds_mp_wifi $(TARGET_DIR)/etc/init.d/S20_rtl8723ds_mp_wifi

  $(INSTALL) -D -m 0755 $(RTL8723DS_MP_DRIVER_PKGDIR)/set_antenna $(TARGET_DIR)/usr/bin/set_antenna
  $(INSTALL) -D -m 0755 $(RTL8723DS_MP_DRIVER_PKGDIR)/w_start $(TARGET_DIR)/usr/bin/w_start
  $(INSTALL) -D -m 0755 $(RTL8723DS_MP_DRIVER_PKGDIR)/w_stop  $(TARGET_DIR)/usr/bin/w_stop
  $(INSTALL) -D -m 0755 $(RTL8723DS_MP_DRIVER_PKGDIR)/w       $(TARGET_DIR)/usr/bin/w
endef
